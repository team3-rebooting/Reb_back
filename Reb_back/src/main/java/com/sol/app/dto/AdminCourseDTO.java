...
public class AdminCourseDTO {
	...
	public String toString() {
		return "AdminCourseDTO [courseNumber=" + courseNumber + ", courseTitle=" + courseTitle + ", courseContent="
				...
				+ expertFieldNumber + ", fieldName=" + fieldName + ", courseRecruitStatusNumber="
				+ courseRecruitStatusNumber + ", courseStatusInfo=" + courseStatusInfo + ", fileCourseList="
				+ fileCourseList + ", coursePostDate=" + coursePostDate + ", coursePostUpdateDate="
				...
				+ courseEndTime + ", courseDayOfWeek=" + courseDayOfWeek + ", courseCount=" + courseCount
				+ ", courseRecruitCount=" + courseRecruitCount + ", coursePrice=" + coursePrice + "]";
	}
