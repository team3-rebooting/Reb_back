	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		routineReviewCommentListDAO.selectList(map).stream().map(gson::toJson).map(JsonParser::parseString)
				.forEach((data) -> {
					...
					o.add("routineReviewNumber", data.getAsJsonObject().get("routineReviewNumber"));
					o.add("routineReviewCommentNumber", data.getAsJsonObject().get("routineReviewCommentNumber"));
					o.add("memberNumber", data.getAsJsonObject().get("memberNumber"));
					o.add("memberNickname", data.getAsJsonObject().get("memberNickname"));
					o.add("routineReviewCreatedDate", data.getAsJsonObject().get("routineReviewCreatedDate"));
					o.add("routineReviewUpdatedDate", data.getAsJsonObject().get("routineReviewUpdatedDate"));
					o.add("routineReviewContent", data.getAsJsonObject().get("routineReviewContent"));
