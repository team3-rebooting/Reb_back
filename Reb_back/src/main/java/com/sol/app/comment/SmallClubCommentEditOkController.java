...
public class SmallClubCommentEditOkController implements Execute {
	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		HttpSession session = request.getSession();
		SmallClubCommentDTO commentDTO = new SmallClubCommentDTO();
		...
		// DTO 설정
		commentDTO.setSmallClubCommentNumber(jsonObject.get("commentNumber").getAsInt());
		commentDTO.setSmallClubContent(jsonObject.get("comment").getAsString());
