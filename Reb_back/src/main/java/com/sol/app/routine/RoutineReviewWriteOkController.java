...
public class RoutineReviewWriteOkController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		routineReviewDTO.setRoutineReviewContent(request.getParameter("routineReviewContent"));
		routineReviewDTO.setRoutineReviewTitle(request.getParameter("routineReviewTitle"));
