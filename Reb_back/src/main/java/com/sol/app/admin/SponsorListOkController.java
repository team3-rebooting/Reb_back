...
public class SponsorListOkController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<AdminSponsorListDTO> sponsorList = sponsorDAO.selectAll(pageMap);
		...
		result.setPath("/app/admin/member/admin-sponsor-list.jsp");
