...
public class LeaderListOkController implements Execute {
	...
	public Result execute(HttpServletRequest request, HttpServletResponse response)
		...
		List<RoutineLeaderDTO> leaderList = leaderDAO.selectAll(pageMap);
		request.setAttribute("leaderList", leaderList);
		int total = leaderDAO.getTotal();
		...
		result.setPath("/app/admin/leader/leader-list.jsp");
