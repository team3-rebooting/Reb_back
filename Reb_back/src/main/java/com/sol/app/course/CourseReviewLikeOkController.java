...
public class CourseReviewLikeOkController implements Execute {
	@Override
	public Result execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		HttpSession session = request.getSession();
		CourseReviewLikeDTO likeDTO = new CourseReviewLikeDTO();
		CourseReviewLikeDAO likeDAO = new CourseReviewLikeDAO();
		...
		// DTO 설정
		likeDTO.setCourseReviewNumber(jsonObject.get("courseNumber").getAsInt());
