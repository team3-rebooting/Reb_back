    ...
    <div class="header-menu-bar">
      ...
      <div class="header-menu-bar-top">
        ...
        <div id="header-menu-bar-top-right">
          <a href="${pageContext.request.contextPath}/main.html" class="font-main">로그아웃</a>
        </div>
      </div>
      <!-- 드롭 다운 가능한 메뉴 -->
      <div class="header-menu-dropdown-list">
        ...
        <div class="header-menu-right">
          ...
          <!-- 마이페이지 버튼 -->
          <a href="${pageContext.request.contextPath}/app/mypage/mypage-password.html"><img src="${pageContext.request.contextPath}/app/assets/img/header/header_side_myPagebutton.png"
              alt=""></a>
        </div>
      </div>
    </div>
