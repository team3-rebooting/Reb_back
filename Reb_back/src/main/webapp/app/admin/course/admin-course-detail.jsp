...
<head>
  ...
  <link rel="stylesheet" href="./../../../assets/css/admin/course/admin-course-detail.css">
...
<script defer src="./../../../assets/js/admin/course/admin-course-detail.js"></script>

<body class="font-menu">
  <!-- 헤더 -->
  <header>
    <!-- 수업 목록 이동 -->
    <a href="./admin-course-list.html">
      <!-- 사이드 로고 -->
