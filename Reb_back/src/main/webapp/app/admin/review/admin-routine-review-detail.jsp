				...
				<div class="div-user-integration">
					...
					<div class="div-user-info">
						...
						<p class="p-update-date">
							<c:choose>
  								<c:when test="${review.routineReviewCreatedDate ne review.routineReviewUpdatedDate}">
    							${fn:substring(review.routineReviewUpdatedDate, 0, 10)}(수정됨)
  								</c:when>
  								<c:otherwise>
    							${fn:substring(review.routineReviewCreatedDate, 0, 10)}
  								</c:otherwise>
							</c:choose>
						</p>
