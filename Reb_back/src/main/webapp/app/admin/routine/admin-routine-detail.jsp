...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/admin/routine/admin-routine-detail.css">
...
<script defer
	src="${pageContext.request.contextPath}/assets/js/admin/routine/admin-routine-detail.js"></script>
				...
				<div class="div-detail-area">
					<div class="div-img">
						<c:forEach var="routineFile" items="${routine.fileRoutineList}">
							<img
								src="${pageContext.request.contextPath}/upload/routine/${routineFile.getFileSystemName()}"
								class="img-detail" alt="루틴 모임 대표 사진">
						</c:forEach>
					</div>
					<div class="div-write-date">
						<c:if
							test="${routine.routineCreatedDate eq routine.routineUpdatedDate}">
						...
						<c:if
							test="${routine.routineCreatedDate ne routine.routineUpdatedDate}">
							<p class="p-write-date">
								작성일 :
								<c:out value="${routine.routineUpdatedDate}" />
								(수정됨)
							</p>
						</c:if>
					</div>
					...
					<div class="div-expert-detail">
						...
						<div class="div-expert-info-detail">
							...
							<p>
								모집 인원 :
								<c:out value="${routine.routineCount}" />
								/
