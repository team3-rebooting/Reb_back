						...
						<div class="div-info-line">
							...
							<div class="div-input-info">
								<label for="monday">월요일</label><input type="checkbox"
									id="monday" name="dow" class="checkbox-input"> <label
									for="tuesday">화요일</label><input type="checkbox" id="tuesday"
									name="dow" class="checkbox-input"> <label
									for="wednesday">수요일</label><input type="checkbox"
									id="wednesday" name="dow" class="checkbox-input"> <label
									for="thursday">목요일</label><input type="checkbox" id="thursday"
									name="dow" class="checkbox-input"> <label for="friday">금요일</label><input
									type="checkbox" id="friday" name="dow" class="checkbox-input">
								<label for="saturday">토요일</label><input type="checkbox"
									id="saturday" name="dow" class="checkbox-input"> <label
									for="sunday">일요일</label><input type="checkbox" id="sunday"
									name="dow" class="checkbox-input">
							</div>
						</div>
						<div class="div-info-line">
