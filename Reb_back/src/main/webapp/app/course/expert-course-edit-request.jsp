						...
						<div class="div-info-line">
							...
							<div class="div-input-info">
								<input type="date" name="courseStartDate" class="input-in"
									required> <input type="date" name="courseEndDate"
									class="input-in" required>
							</div>
						</div>
						<div class="div-info-line">
							...
							<div class="div-input-info">
								<input type="time" name="courseStartTime" class="input-in"
									required> <input type="time" name="courseEndTime"
									class="input-in" required>
							</div>
						</div>
						<div class="div-info-line">
							...
							<div class="div-input-info">
								<label for="monday">월요일</label><input type="checkbox"
									id="monday" name="dow" class="checkbox-input input-day"
									value="mon" class="font-main"> <label for="tuesday">화요일</label><input
									type="checkbox" id="tuesday" name="dow"
									class="checkbox-input input-day" value="tue" class="font-main">
								...
								<label for="thursday">목요일</label><input type="checkbox"
									...
									value="thu" class="font-main"> <label for="friday">금요일</label><input
									type="checkbox" id="friday" name="dow"
									class="checkbox-input input-day" value="fri" class="font-main">
								<label for="saturday">토요일</label><input type="checkbox"
									id="saturday" name="dow" class="checkbox-input input-day"
									value="sat" class="font-main"> <label for="sunday">일요일</label><input
									type="checkbox" id="sunday" name="dow"
									class="checkbox-input input-day" value="sun" class="font-main">
							</div>
						</div>
						<div class="div-info-line">
