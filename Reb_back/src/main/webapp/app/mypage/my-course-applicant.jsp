...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/mypage/my-course-applicant.css">
    ...
    <script defer src="${pageContext.request.contextPath}/assets/js/mypage/my-course-applicant.js"></script>
    <title>틈새빛</title>
</head>
