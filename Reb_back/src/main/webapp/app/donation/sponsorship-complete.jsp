...
<head>
  ...
  <link
    ...
    rel="stylesheet">
  <script defer src="./../../assets/js/donation/sponsorship-complete.js"></script>
  <title>틈새빛</title>
</head>
  ...
  <main>
    ...
    <div id="main-container">
      ...
      <div class="sponsorship-complete-text font-main">
        30,000원 후원이 완료되었습니다.<br>
        자세한 사항은 마이페이지에서 확인 하실 수 있습니다.
      </div>
      <!-- 버튼 -->
      <div id="sponsorship-complete-bottom">
        <a href="./../../main.html"> 메인페이지로</a>
        <a href="./../mypage/my-sponsorship.html">나의 후원 내역</a>
      </div>
    </div>
  </main>
  <!-- 푸터 -->
